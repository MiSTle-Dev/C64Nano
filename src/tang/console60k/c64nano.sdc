...
set_clock_groups -asynchronous -group [get_clocks {clk_sys}] -group [get_clocks {clk_pixel_x5_pal}]
set_clock_groups -asynchronous -group [get_clocks {clk_sys}] -group [get_clocks {clk_pixel_x5_ntsc}]
set_clock_groups -asynchronous -group [get_clocks {clk_sys}] -group [get_clocks {clk64_pal}]
set_clock_groups -asynchronous -group [get_clocks {clk_sys}] -group [get_clocks {clk64_ntsc}]
