create_clock -name spi_io_clk -period 50 -waveform {0 25} [get_ports {pmod_companion_clk}]
...
create_generated_clock -name clk_ck -source [get_ports {clk}] -master_clock clk -divide_by 3 -multiply_by 35 -duty_cycle 50 -phase 180 [get_pins {mainclock/CLKOUTP}]
create_generated_clock -name p_clk -source [get_ports {clk}] -master_clock clk -divide_by 12 -multiply_by 35 [get_pins {mainclock/CLKOUTD}]
...
create_generated_clock -name clk_pixel_x5 -source [get_pins {mainclock/CLKOUT}] -master_clock clk_pixel_x10 -divide_by 2 -multiply_by 1 [get_pins {div3_inst/CLKOUT}]
