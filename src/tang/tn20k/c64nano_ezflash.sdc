...
//set_multicycle_path -from [get_clocks {clk_sys}] -to [get_clocks {clk64}]  -setup -start 2
//set_multicycle_path -from [get_clocks {clk_sys}] -to [get_clocks {clk64}]  -hold -start 2