...
set_clock_groups -asynchronous -group [get_clocks {clk_audio}] -group [get_clocks {clk_sys}] 
set_clock_groups -asynchronous -group [get_clocks {clk64}] -group [get_clocks {clk_sys}]
